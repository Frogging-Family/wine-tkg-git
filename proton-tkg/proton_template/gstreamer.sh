...
#	( cd "$_nowhere"/external-resources/FFmpeg && patch -Np1 < "$_nowhere"/proton_template/ffmpeg_binutils.patch )
  ...
  meson_options=(
    ...
    -D gst-plugins-base:glib_debug=false
    ...
    -D gst-plugins-good:glib_debug=false
    ...
    -D gst-plugins-bad:glib_debug=false
    ...
    -D gst-plugins-ugly:glib_debug=false
    -D gst-rtsp-server:glib_debug=false
