...
_prepare() {
	...
	if ( [ "$_update_winevulkan" = "true" ] || [ "$_proton_fs_hack" = "true" ] ) && ( cd "${srcdir}"/"${_stgsrcdir}" && git merge-base --is-ancestor df2fd22e4de96b28eb0ced5e8aa9bf4c421b5ed8 HEAD && ! git merge-base --is-ancestor 23ae4e6c7ac3b4c463ea79944dac62affe6173bf HEAD ); then
